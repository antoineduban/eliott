...
namespace SpaceShooter {
    ...
    // Laser hits asteroid
    sprites.onOverlap(LaserKind, AsteroidKind, function (laser, asteroid) {
        laser.destroy();
    ...
    // Laser hits alien
    sprites.onOverlap(LaserKind, AlienKind, function (laser, alien) {
        laser.destroy();
    ...
    sprites.onOverlap(ShipKind, AsteroidKind, function (ship, asteroid) {
        asteroid.destroy();
        game.over(false, effects.dissolve);
    });

    // Ship hits alien = GAME OVER
    sprites.onOverlap(ShipKind, AlienKind, function (ship, alien) {
        alien.destroy();
        game.over(false, effects.dissolve);
    });
}
